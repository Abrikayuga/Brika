...
<head>
    ...
    <title>Pohon Pucuk Merah</title>
    <!-- CSS Dimasukkan Langsung di Sini -->
    <style>
        /* Style untuk seluruh website */
        body {
            font-family: Arial, sans-serif;
            margin: 0;
            padding: 0;
            background-color: #e0f7e9; /* Warna hijau muda lembut */
            color: #333;
        }
        ...
        h2 {
            color: #388E3C; /* Warna hijau lebih gelap */
        }
        ...
        ul li::before {
            content: "•";
            color: #4CAF50; /* Warna hijau untuk bullet points */
            position: absolute;
            left: 0;
            top: 0;
        }
